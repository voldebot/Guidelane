...
import { validateStreamSurface } from './lib/stream-surface-schema.mjs'
...
// The stream-surface validator lives in lib/stream-surface-schema.mjs, imported
// above. It used to live here, and the engine package grew a SECOND, weaker
// implementation of the same pinned expectation — the exact drift the original
// docstring warned about, one directory away. One copy now, shared.
